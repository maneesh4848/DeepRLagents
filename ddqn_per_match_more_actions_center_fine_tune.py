...
if __name__ == "__main__":
	...
	game = DoomGame()
	game.load_config("./scenarios/deathmatch_modified.cfg")
	game.set_sound_enabled(False)
	game.set_screen_resolution(ScreenResolution.RES_640X480)
	game.set_window_visible(False)
	game.init()

	json_file_name = 'statistics/ddqn_per_match_more_actions_center_fine_tune_ph4.txt' #Saved every episode # (epoch_num,game_num,ammo,health,score)
	load_model_file_name = "models/ddqn_per_center_more_actions_basic_fine_tune_ph4.h5" #Model from which it is initialized
	save_model_file_name = "models/ddqn_per_match_more_actions_center_fine_tune_ph4.h5" #Saved every epoch
	save_stats_file_name = "statistics/old_stats_ddqn_per_match_more_actions_center_fine_tune_ph4.txt" #Saved every epoch
