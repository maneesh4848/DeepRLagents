...
if __name__ == "__main__":
	...
	json_file_name = 'statistics/ddqn_per_match_more_actions_ph4.txt' #Saved every episode # (epoch_num,game_num,ammo,health,score)
	##load_model_file_name = "./models/ddqn_centre_temp.h5" #Model from which it is initialized
	save_model_file_name = "models/ddqn_per_match_more_actions_ph4.h5" #Saved every epoch
	save_stats_file_name = "statistics/old_stats_ddqn_per_match_more_actions_ph4.txt" #Saved every epoch
