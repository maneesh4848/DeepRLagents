...
if __name__ == "__main__":
    ...
    json_file_name = 'statistics/new_ddqn_basic_ph1.txt' #Saved every episode # (epoch_num,game_num,ammo,health,score)
    ...
    save_stats_file_name = "statistics/old_stats_new_ddqn_basic_ph1.txt" #Saved every epoch
