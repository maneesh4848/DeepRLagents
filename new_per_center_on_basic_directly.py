...
if __name__ == "__main__":
	...
	json_file_name = 'statistics/per_center_on_basic_directly_ph3.txt' #Saved every episode # (epoch_num,game_num,ammo,health,score)
	load_model_file_name = "models/new_ddqn_per_center_ph1.h5" #Model from which it is initialized
	save_model_file_name = "models/per_center_on_basic_directly_ph3.h5" #Saved every epoch
	save_stats_file_name = "statistics/old_stats_per_center_on_basic_directly_ph3.txt" #Saved every epoch
