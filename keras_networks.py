...
class Networks(object):
    ...
    @staticmethod
    def new_dqn(input_dim, output_dim, learning_rate):
    
        model=Sequential()
        model.add(kl.Conv2D(16, (4,4), strides = (4,4), activation = 'relu', use_bias = True, kernel_initializer = 'he_normal', bias_initializer = Constant(value = 0.1), input_shape = input_dim))
        model.add(kl.Conv2D(32, (2,2), strides = (2,2), activation = 'relu', use_bias = True, kernel_initializer = 'he_normal', bias_initializer = Constant(value = 0.1), input_shape = input_dim))
        model.add(kl.Conv2D(64, (2,2), strides = (2,2), activation = 'relu', use_bias = True, kernel_initializer = 'he_normal', bias_initializer = Constant(value = 0.1), input_shape = input_dim))
        model.add(kl.Flatten())
        model.add(kl.Dense(512, activation = 'relu', use_bias = True, kernel_initializer = 'he_normal', bias_initializer = Constant(value = 0.1)))
        model.add(kl.Dense(output_dim, use_bias = True, kernel_initializer = 'he_normal', bias_initializer = Constant(value = 0.1)))
