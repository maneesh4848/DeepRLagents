...
if __name__ == "__main__":
    ...
    for ep in range(epochs):
        ...
        agent.model.save_weights("models/ddqn_basic_"+str(time.time())[:-3]+".h5", overwrite=True)
        ...
        if ep*games_per_epoch % agent.stats_window_size == 0 and t > agent.observe: 
            ...
            with open("statistics/ddqn_stats_basic_"+str(time.time())[:-3]+".txt", "w") as stats_file:
