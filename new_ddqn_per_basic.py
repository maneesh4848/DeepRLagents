...
if __name__ == "__main__":
	...
	save_model_file_name = "models/new_ddqn_per_basic_ph1.h5" #Saved every epoch
	save_stats_file_name = "statistics/old_stats_new_ddqn_per_basic_ph1.txt" #Saved every epoch
