...
if __name__ == "__main__":
	...
	game = DoomGame()
	game.load_config("./scenarios/modified_simpler_basic.cfg")
	...
	json_file_name = 'statistics/new_ddqn_per_basic_more_actions_new_ph4.txt' #Saved every episode # (epoch_num,game_num,ammo,health,score)
	#load_model_file_name = "./models/ddqn_centre_temp.h5" #Model from which it is initialized
	save_model_file_name = "models/new_ddqn_per_basic_more_actions_new_ph4.h5" #Saved every epoch
	save_stats_file_name = "statistics/old_stats_ddqn_per_basic_more_actions_new_ph4.txt" #Saved every epoch
